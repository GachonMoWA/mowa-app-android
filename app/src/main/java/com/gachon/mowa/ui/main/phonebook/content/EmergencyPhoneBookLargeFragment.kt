...
import com.gachon.mowa.databinding.FragmentEmergencyPhoneBookLargeBinding

class EmergencyPhoneBookLargeFragment :
    BaseFragment<FragmentEmergencyPhoneBookLargeBinding>(FragmentEmergencyPhoneBookLargeBinding::inflate) {
    companion object {
